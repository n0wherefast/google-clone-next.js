  ...
  return (
    <div className='  flex justify-center flex-shrink-0   box-border w-full max-h-[160px] p-5'>
        ...
        <div className=' my-0 mb-6 mx-auto w-auto max-w-[584px] pt-[6px] relative '>
            <div className=' hover:shadow-[0_2px_10px_rgba(0,0,0,0.3)] flex  z-10 relative min-h-[44px] border border-[#dfe1e5;] shadow-none rounded-3xl my-0 w-auto  max-w-[584px]'>  
                <div className='  flex  items-center  flex-1 pt-[5px] pr-[8px] p-[5px]  pl-[14px] '>
                    ...
                    <div className='flex flex-wrap flex-1 mt-2'>
                         <input type="area"  className=' w-full  mb-2 overflow-x-hidden resize-none bg-transparent border-none m-0 p-0 text-black break-words outline-none flex leading-[22px]' />
                     </div>
                    <div className='flex  gap-2 h-auto w-auto items-center'>
                       <div className=" ">
                         <svg className=" h-6 w-6 align-middle" focusable="false" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="#4285f4" d="m12 15c1.66 0 3-1.31 3-2.97v-7.02c0-1.66-1.34-3.01-3-3.01s-3 1.34-3 3.01v7.02c0 1.66 1.34 2.97 3 2.97z"></path><path fill="#34a853" d="m11 18.08h2v3.92h-2z"></path><path fill="#fbbc05" d="m7.05 16.87c-1.27-1.33-2.05-2.83-2.05-4.87h2c0 1.45 0.56 2.42 1.47 3.38v0.32l-1.15 1.18z"></path><path fill="#ea4335" d="m12 16.93a4.97 5.25 0 0 1 -3.54 -1.55l-1.41 1.49c1.26 1.34 3.02 2.13 4.95 2.13 3.87 0 6.99-2.92 6.99-7h-1.99c0 2.92-2.24 4.93-5 4.93z"></path></svg>
                    </div>
                    <div className="">
        ...
        <div className=' text-sm w-full p-2 h-[5rem] flex gap-5 justify-center items-center '>
